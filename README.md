## Мое портфолио
Я разместил здесь примеры моего кода вместе с кратким описанием того, какие задачи этот код решает. Это мои личные проекты или решения некоторых задач с курсов, которые я проходил за последние 3 года. Код, который я писал до этого (в процессе работы в "Боронд" и "Яндекс") я размещать не могу даже частично согласно условиям договора с работодателем. 
