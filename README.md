## Мое портфолио
Я разместил здесь несколько примеров моего кода, который был написан за последние 5 лет. С 2017 года я не работал официально, поэтому, это какие-то части моих личных проектов, проектов на фрилансе или решения задач с курсов, которые я проходил.
